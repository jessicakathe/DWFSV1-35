 ...
 * @param items
 * @param useCallback
 * @description this method use for through callback call buildData, encodeBase64, and wordToCapitalize
 */
const validationMethods = (items, useCallback) => {
...
const getDataFormMyForm = () => {
  ...
  firstname = validationMethods(floatingInputName, wordToCapitalize);
  lastName = validationMethods(floatingInputLastname, wordToCapitalize);
  phone = floatingInputPhone;
  password = validationMethods(floatingPassword, encodeBase64);
